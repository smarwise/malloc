...
size_t       show_tiny()
{
    ...
    {
        ft_putstr("0x");
        ft_putstr(ft_tolower(ft_itoa_base((int)block->tiny_allocs->pointer, 16)));
        ft_putstr(" - 0x");
        ft_putstr(ft_tolower(ft_itoa_base((int)block->tiny_allocs->pointer + block->tiny_allocs->size, 16)));
        ft_putstr(" : ");
...
size_t        show_small()
{
    ...
    while (block->small)
    {
        ...
        ft_putstr(" - 0x");
        ft_putstr(ft_tolower(ft_itoa_base((int)block->small->pointer + block->small->size, 16)));
        ft_putstr(" : ");
...
size_t    show_large()
{
    ...
    while (block->large)
    {
        ...
        ft_putstr(" - 0x");
        ft_putstr(ft_tolower(ft_itoa_base((int)block->large->pointer + block->large->size, 16)));
        ft_putstr(" : ");
